...
@schedule_bp.route("/<int:slot_id>", methods=["GET"], strict_slashes=False)
def slot_get(slot_id: int):
...
@schedule_bp.route("/<int:slot_id>", methods=["PUT"], strict_slashes=False)
@roles_required("manager", "admin")
...
@schedule_bp.route("/<int:slot_id>", methods=["DELETE"], strict_slashes=False)
